...
Экстренное приложение, которое удаляет данные с телефона при вводе и отправке любого кода заданной вами длины для сброса вместо пароля на экране блокировки.
...
Таким образом, эту Fail-Safe защиту сложнее обойти в безопасном режиме или в случае остановки работы приложения.
...
Поскольку триггером сброса является длина, приложение НЕ требует чтобы отображение символов было включено.
